...
with open(os.path.join('assets', 'highscore.json')) as config_file:
...
BACKGROUND = pygame.image.load(os.path.join('assets', 'biggras.png'))
...
def GameOver_show_message():
    font = pygame.font.Font("assets/Pixeled.ttf", scale * 2)
...
def hudPaint():
    font = pygame.font.Font("assets/Pixeled.ttf", scale)
...
def countDown():
    ...
    font = pygame.font.Font("assets/Pixeled.ttf", scale * 3)
