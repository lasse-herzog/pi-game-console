...
<template>
  <section>
    <div class="text">
      ...
      <p>
        Musterhosting AG
        <br />Musterweg 100 <br />90210 Musterstadt
      </p>
      ...
      <p>
        Beispielfirma
        <br />Musterweg 10 <br />90210 Musterstadt
      </p>
      ...
      <p>
        ...
        &bdquo;Re-Tweet&ldquo; werden die von Ihnen besuchten Websites mit Ihrem
        Twitter-Account verkn&uuml;pft und anderen Nutzern bekannt gegeben.
        Dabei werden auch Daten an Twitter &uuml;bertragen. Wir weisen darauf
        hin, dass wir als Anbieter der Seiten keine Kenntnis vom Inhalt der
      ...
      <p>
        ...
        stellt Ihr Browser eine direkte Verbindung zu den Servern von Pinterest
        her. Das Plugin &uuml;bermittelt dabei Protokolldaten an den Server von
        Pinterest in die USA. Diese Protokolldaten enthalten m&ouml;glicherweise
      ...
      <p>
        ...
        verwendet Technologien, die die seiten&uuml;bergreifende Wiedererkennung
        des Nutzers zur Analyse des Nutzerverhaltens erm&ouml;glichen
        (z.&nbsp;B. Cookies oder Device-Fingerprinting). Die durch Matomo
        erfassten Informationen &uuml;ber die Benutzung dieser Website werden
      ...
      <p>
        ...
        sodass sie nicht zu einzelnen Personen zur&uuml;ckverfolgt werden kann.
      ...
      <p>
        ...
        Besucherzugriffe statistisch auszuwerten. Anbieter ist die Aut
        O&rsquo;Mattic A8C Ireland Ltd., Business Centre, No.1 Lower Mayor
        Street, International Financial Services Centre, Dublin 1, Irland, deren
        Mutterunternehmen in den USA sitzt.
      </p>
      <p>
      ...
      <p>
        ...
        dabei gek&uuml;rzt, sodass diese Ihnen nicht mehr direkt zugeordnet
        werden kann.
      </p>
      <h2>7. Newsletter</h2>
      ...
      <p>
        Die Fonts sind lokal installiert. Eine &Uuml;bertragung
        personenbezogener Daten an MyFonts findet nicht statt. Der Einsatz der
        Fonts erfolgt auf Grundlage unseres berechtigten Interesses an einer
        einheitlichen Darstellung unserer Website (Art. 6 Abs. 1 lit. f DSGVO).
      </p>
      <h3>Google Maps</h3>
      <p>
      ...
      <p>
        ...
        der Nutzung der OpenStreetMap-Karten wird eine Verbindung zu den Servern
        der OpenStreetMap-Foundation hergestellt. Dabei k&ouml;nnen u. a. Ihre
        ...
        hierzu unter Umst&auml;nden Cookies in Ihrem Browser oder setzt
      ...
      <h3>Wordfence</h3>
      <p>
        Wir haben Wordfence auf dieser Website eingebunden. Anbieter ist Defiant
        Inc., Defiant, Inc., 800 5th Ave Ste 4100, Seattle, WA 98104, USA
        (nachfolgend &bdquo;Wordfence&ldquo;).
      </p>
      <p>
        Wordfence dient dem Schutz unserer Website vor unerw&uuml;nschten
        Zugriffen oder b&ouml;sartigen Cyberattacken. Zu diesem Zweck stellt
        unsere Website eine dauerhafte Verbindung zu den Servern von Wordfence
        her, damit Wordfence seine Datenbanken mit den auf unserer Website
        get&auml;tigten Zugriffen abgleichen und ggf. blockieren kann.
      </p>
      <p>
        Die Verwendung von Wordfence erfolgt auf Grundlage von Art. 6 Abs. 1
        lit. f DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse an
        einem m&ouml;glichst effektiven Schutz seiner Website vor Cyberattacken.
        Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt die
        Verarbeitung ausschlie&szlig;lich auf Grundlage von Art. 6 Abs. 1 lit. a
        DSGVO und &sect; 25 Abs. 1 TTDSG, soweit die Einwilligung die
        Speicherung von Cookies oder den Zugriff auf Informationen im
      ...
      <p>
        Wir haben iThemes Security auf dieser Website eingebunden. Anbieter ist
        die iThemes Media LLC, 1720 South Kelly Avenue Edmond, OK 73013, USA
        (nachfolgend &bdquo;iThemes Security&ldquo;).
      </p>
      <p>
        iThemes Security dient dem Schutz unserer Website vor unerw&uuml;nschten
        Zugriffen oder b&ouml;sartigen Cyberattacken. Zu diesem Zweck erfasst
        iThemes Security u.&nbsp;a. Ihre IP-Adresse, Zeitpunkt und Quelle von
        Login-Versuchen und Log-Daten (z.&nbsp;B. den verwendeten Browser).
        iThemes Security wird lokal auf unseren Servern installiert.
      </p>
      <p>
        iThemes Security &uuml;bermittelt IP-Adressen von wiederkehrenden
        Angreifern an eine zentrale Datenbank von iThemes in die USA (Network
        Brute Force Protection), um derartige Angriffe k&uuml;nftig zu
        unterbinden.
      </p>
      <p>
        Die Verwendung von iThemes Security erfolgt auf Grundlage von Art. 6
        Abs. 1 lit. f DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse
        an einem m&ouml;glichst effektiven Schutz seiner Website vor
        Cyberattacken. Sofern eine entsprechende Einwilligung abgefragt wurde,
        erfolgt die Verarbeitung ausschlie&szlig;lich auf Grundlage von Art. 6
        Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TTDSG, soweit die Einwilligung
      ...
      <p>
        ...
        (im folgenden &bdquo;OneDrive&ldquo;).
      </p>
      <p>
        OneDrive erm&ouml;glicht es uns, einen Uploadbereich auf unserer Website
        einzubinden, in dem Sie Inhalte hochladen k&ouml;nnen. Wenn Sie Inhalte
        hochladen, werden diese auf den Servern von OneDrive gespeichert. Wenn
        Sie unsere Website betreten, wird au&szlig;erdem eine Verbindung zu
        OneDrive aufgebaut, sodass OneDrive feststellen kann, dass Sie unsere
      ...
      <p>
        ...
        zuverl&auml;ssigen Uploadbereich auf seiner Website. Sofern eine
        entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung
      ...
      <p>
        Google Drive erm&ouml;glicht es uns, einen Uploadbereich auf unserer
        Website einzubinden, in dem Sie Inhalte hochladen k&ouml;nnen. Wenn Sie
        Inhalte hochladen, werden diese auf den Servern von Google Drive
        gespeichert. Wenn Sie unsere Website betreten, wird au&szlig;erdem eine
        Verbindung zu Google Drive aufgebaut, sodass Google Drive feststellen
        kann, dass Sie unsere Website besucht haben.
      </p>
      <p>
        Die Verwendung von Google Drive erfolgt auf Grundlage von Art. 6 Abs. 1
        lit. f DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse an
        einem zuverl&auml;ssigen Uploadbereich auf seiner Website. Sofern eine
        entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung
        ausschlie&szlig;lich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO; die
        Einwilligung ist jederzeit widerrufbar.
      </p>
