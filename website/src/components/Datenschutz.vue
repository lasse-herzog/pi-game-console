...
<template>
    <section>
        <div class="text">
            ...
            <p>Das Aktivieren des Plugins stellt eine Einwilligung im Sinne des Art. 6 Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TTDSG dar. Diese Einwilligung k&ouml;nnen Sie jederzeit mit Wirkung f&uuml;r die Zukunft widerrufen.</p>
            ...
            <p>
                Die Facebook Plugins erkennen Sie an dem Facebook-Logo oder dem &bdquo;Like-Button&ldquo; (&bdquo;Gef&auml;llt mir&ldquo;) auf dieser Website. Eine &Uuml;bersicht &uuml;ber die Facebook Plugins finden Sie hier:
                <a
            ...
            <p>
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                >https://de-de.facebook.com/help/566994660333381</a> und
                <a
            ...
            <p>
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                >https://twitter.com/account/settings</a> &auml;ndern.
            </p>
            ...
            <h3>Tumblr Plugin</h3>
            <p>Diese Website nutzt Schaltfl&auml;chen des Dienstes Tumblr. Anbieter ist die Tumblr, Inc., 35 East 21st St, 10th Floor, New York, NY 10010, USA.</p>
            ...
            <p>
                Weitere Informationen zu Zweck, Umfang und weiterer Verarbeitung und Nutzung der Daten durch Pinterest sowie Ihre diesbez&uuml;glichen Rechte und M&ouml;glichkeiten zum Schutz Ihrer Privatsph&auml;re finden Sie in den Datenschutzhinweisen von Pinterest:
                <a
            ...
            <p>Diese Website nutzt &bdquo;WordPress Statistik&ldquo;, um Besucherzugriffe statistisch auszuwerten. Anbieter ist die Aut O&rsquo;Mattic A8C Ireland Ltd., Business Centre, No.1 Lower Mayor Street, International Financial Services Centre, Dublin 1, Irland, deren Mutterunternehmen in den USA sitzt.</p>
            ...
            <h3>WP Statistics</h3>
            <p>
                Diese Website nutzt das Analysetool WP Statistics, um Besucherzugriffe statistisch auszuwerten. Anbieter ist Veronalabs, ARENCO Tower, 27th Floor, Dubai Media City, Dubai, Dubai 23816, UAE (
                <a
            ...
            <p>Mit WP Statistics k&ouml;nnen wir die Nutzung unserer Website analysieren. WP Statistics erfasst dabei u.&nbsp;a. Logdateien (IP-Adresse, Referrer, verwendete Browser, Herkunft des Nutzers, verwendete Suchmaschine) und Aktionen, die die Websitebesucher auf der Seite get&auml;tigt haben (z.&nbsp;B. Klicks und Ansichten).</p>
            <p>Die mit WP Statistics erfassten Daten werden ausschlie&szlig;lich auf unserem eigenen Server gespeichert.</p>
            ...
            <h4>IP-Anonymisierung</h4>
            <p>Wir verwenden WP Statistics mit anonymisierter IP. Ihre IP-Adresse wird dabei gek&uuml;rzt, sodass diese Ihnen nicht mehr direkt zugeordnet werden kann.</p>
            <h2>7. Newsletter</h2>
            ...
            <p>
                Die Daten&uuml;bertragung in die USA wird auf die Standardvertragsklauseln der EU-Kommission sowie nach Aussage von Vimeo auf &bdquo;berechtigte Gesch&auml;ftsinteressen&ldquo; gest&uuml;tzt. Details finden Sie hier:
                <a
            ...
            <h3>MyFonts</h3>
            <p>Diese Seite nutzt zur einheitlichen Darstellung von Schriftarten so genannte Web Fonts von MyFonts Inc., 600 Unicorn Park Drive, Woburn, Massachusetts 01801 USA (nachfolgend MyFonts). Hierbei handelt es sich um Schriftarten, die beim Aufrufen unserer Website in Ihren Browser geladen werden, um ein einheitliches Schriftbild bei der Webseitendarstellung zu gew&auml;hrleisten.</p>
            <p>Die Fonts sind lokal installiert. Eine &Uuml;bertragung personenbezogener Daten an MyFonts findet nicht statt. Der Einsatz der Fonts erfolgt auf Grundlage unseres berechtigten Interesses an einer einheitlichen Darstellung unserer Website (Art. 6 Abs. 1 lit. f DSGVO).</p>
            <h3>Google Maps</h3>
            ...
            <p>iThemes Security &uuml;bermittelt IP-Adressen von wiederkehrenden Angreifern an eine zentrale Datenbank von iThemes in die USA (Network Brute Force Protection), um derartige Angriffe k&uuml;nftig zu unterbinden.</p>
            ...
            <h3>OneDrive</h3>
            <p>Wir haben OneDrive auf dieser Website eingebunden. Anbieter ist die Microsoft Corporation, One Microsoft Way, Redmond, WA 98052-6399, USA (im folgenden &bdquo;OneDrive&ldquo;).</p>
            <p>OneDrive erm&ouml;glicht es uns, einen Uploadbereich auf unserer Website einzubinden, in dem Sie Inhalte hochladen k&ouml;nnen. Wenn Sie Inhalte hochladen, werden diese auf den Servern von OneDrive gespeichert. Wenn Sie unsere Website betreten, wird au&szlig;erdem eine Verbindung zu OneDrive aufgebaut, sodass OneDrive feststellen kann, dass Sie unsere Website besucht haben.</p>
            ...
            <p>Wir haben einen Vertrag &uuml;ber Auftragsverarbeitung (AVV) mit dem oben genannten Anbieter geschlossen. Hierbei handelt es sich um einen datenschutzrechtlich vorgeschriebenen Vertrag, der gew&auml;hrleistet, dass dieser die personenbezogenen Daten unserer Websitebesucher nur nach unseren Weisungen und unter Einhaltung der DSGVO verarbeitet.</p>
            <h3>Google Drive</h3>
            <p>Wir haben Google Drive auf dieser Website eingebunden. Anbieter ist die Google Ireland Limited (&bdquo;Google&ldquo;), Gordon House, Barrow Street, Dublin 4, Irland.</p>
            <p>Google Drive erm&ouml;glicht es uns, einen Uploadbereich auf unserer Website einzubinden, in dem Sie Inhalte hochladen k&ouml;nnen. Wenn Sie Inhalte hochladen, werden diese auf den Servern von Google Drive gespeichert. Wenn Sie unsere Website betreten, wird au&szlig;erdem eine Verbindung zu Google Drive aufgebaut, sodass Google Drive feststellen kann, dass Sie unsere Website besucht haben.</p>
